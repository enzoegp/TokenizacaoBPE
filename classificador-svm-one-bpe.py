...
for index in range(0,3):
    ...
    for k in range(4,5,1):
        ...
        data = np.loadtxt(pathDict[index] + 'one-' + str(vocab_size) + '-bpe.csv', dtype=np.float64, delimiter=',')
    ...
    print('Imprimindo estatísticas para representação oneHot de bpe.')
    # printar a lista em ordem
    resultFile = open(pathDict[index] + 'one-results-bpe.txt','w')
